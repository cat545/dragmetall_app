...
class ElementsPage extends StatefulWidget {
  String? way;
  String? titlePage;
  ElementsPage({Key? key, this.way, this.titlePage}) : super(key: key);
...
class _ElementsPageState extends State<ElementsPage> {
  ...
  @override
  void initState() {
    requestNewScreen("<elements page>");
    startElementsList();
    super.initState();
  }
  ...
  Widget element(elementPage) {
    return ListTile(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => SinglePage(way: widget.way, titlePage: elementPage.name, singleElement: elementPage )));
      },
    ...
    return Container(
        ...
        child: Row(
          children: [
            ...
            const Icon(Icons.subdirectory_arrow_right, color: Colors.white38),
            const SizedBox(width: 8),
            Expanded(
              child: Text(
